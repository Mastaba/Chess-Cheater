...
- Includes Learn Opening mode, which matches the current line against 280 bundled opening PGNs and shows which selected-piece moves keep you in the opening book.
